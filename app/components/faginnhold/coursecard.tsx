...
export default function CourseCard({ course }: { course: Course }) {
  return (
    <Link
      href={course.href ?? "#"}
      className="group block overflow-hidden rounded-2xl border bg-white/60 shadow-sm ring-1 ring-black/5 transition hover:-translate-y-0.5 hover:shadow-md dark:bg-neutral-900/70"
    >
